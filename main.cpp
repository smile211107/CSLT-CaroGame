...
void loadTextures()
{
    ...
    school.loadFromFile("assets/background/weebSchool.png");
    street.loadFromFile("assets/background/weebStreet.png");
...
RenderWindow window(desktop, "Game Caro", Style::Resize);
...
{
    // Tao window
    RenderWindow window(VideoMode({ 1920, 1080 }), "vttaan's work");
