...

{
    ...
    this->endButtons.push_back(move(buttonNewGame));
    this->endButtons.push_back(move(buttonSaveGame));
    this->endButtons.push_back(move(buttonExit));
    ...
    if (auto* key = event.getIf<sf::Event::KeyPressed>())
    {
        if (endGame)
        {
            ...
            if (key->scancode == sf::Keyboard::Scancode::W || key->scancode == sf::Keyboard::Scancode::Up) {
                ...
                /*auto& currentButton = endButtons[selectedButtonIndex];
                ...
                else if (currentButton == buttonSaveGame) {
